...
execute if score Timerattack NAMEGOT matches 40.. if score NUMBERTP NAMEGOT matches 1.. run function att:gameplay/boss/desolation/namegot/gray/tp
execute if score Timerattack NAMEGOT matches 44.. if score NUMBERTP NAMEGOT matches 2.. run function att:gameplay/boss/desolation/namegot/gray/tp
execute if score Timerattack NAMEGOT matches 48.. if score NUMBERTP NAMEGOT matches 3.. run function att:gameplay/boss/desolation/namegot/gray/tp
execute if score Timerattack NAMEGOT matches 52.. if score NUMBERTP NAMEGOT matches 4.. run function att:gameplay/boss/desolation/namegot/gray/tp
execute if score Timerattack NAMEGOT matches 56.. if score NUMBERTP NAMEGOT matches 5.. run function att:gameplay/boss/desolation/namegot/gray/tp
