...
execute if score Timerattack NAMEGOT matches 0 at @e[type=wither_skeleton,tag=NAMEGOT] run particle minecraft:item{item:blue_wool} ~ ~ ~ 1 1 1 0.1 100
execute if score Timerattack NAMEGOT matches 5 at @e[type=wither_skeleton,tag=NAMEGOT] run particle minecraft:item{item:blue_wool} ~ ~ ~ 1 1 1 0.08 100
execute if score Timerattack NAMEGOT matches 10 at @e[type=wither_skeleton,tag=NAMEGOT] run particle minecraft:item{item:blue_wool} ~ ~3 ~ 1 1 1 0.06 100
execute if score Timerattack NAMEGOT matches 15 at @e[type=wither_skeleton,tag=NAMEGOT] run particle minecraft:item{item:blue_wool} ~ ~3 ~ 1 1 1 0.04 100
execute if score Timerattack NAMEGOT matches 20 at @e[type=wither_skeleton,tag=NAMEGOT] run particle minecraft:item{item:blue_wool} ~ ~3 ~ 1 1 1 0.03 100
execute if score Timerattack NAMEGOT matches 25 at @e[type=wither_skeleton,tag=NAMEGOT] run particle minecraft:item{item:blue_wool} ~ ~4 ~ 1 1 1 0.02 100
execute if score Timerattack NAMEGOT matches 30 at @e[type=wither_skeleton,tag=NAMEGOT] run particle minecraft:item{item:blue_wool} ~ ~4 ~ 0.5 1 0.5 0.02 100
execute if score Timerattack NAMEGOT matches 35 at @e[type=wither_skeleton,tag=NAMEGOT] run particle minecraft:item{item:blue_wool} ~ ~4 ~ 0.5 1 0.5 0.02 100
