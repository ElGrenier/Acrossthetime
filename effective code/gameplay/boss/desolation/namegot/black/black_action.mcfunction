...
execute if score Timerattack NAMEGOT matches 40 at @e[type=wither_skeleton,tag=NAMEGOT] run tellraw @a {"text":"-°- Esprit Gardien : ","bold":true,"color":"dark_gray","extra":[{"text":"Frappe Namégot de toutes tes forces vite!!!!!","italic":true,"color":"dark_green","bold":false}]}
