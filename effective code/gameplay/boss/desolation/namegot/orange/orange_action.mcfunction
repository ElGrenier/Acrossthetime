...
execute if score Timerattack NAMEGOT matches 20 at @e[type=wither_skeleton,tag=NAMEGOT] run particle item{item:orange_wool} ~ ~3 ~ 1 1 1 0.04 100

execute if score Timerattack NAMEGOT matches 20 at @e[type=wither_skeleton,tag=NAMEGOT] run playsound entity.player.death master @a ~ ~ ~ 1 0.1 1
...
execute if score Timerattack NAMEGOT matches 25 at @e[type=wither_skeleton,tag=NAMEGOT] run particle item{item:orange_wool} ~ ~3 ~ 1 1 1 0.03 100
execute if score Timerattack NAMEGOT matches 30 at @e[type=wither_skeleton,tag=NAMEGOT] run particle item{item:orange_wool} ~ ~4 ~ 1 1 1 0.02 100
execute if score Timerattack NAMEGOT matches 35 at @e[type=wither_skeleton,tag=NAMEGOT] run particle item{item:orange_wool} ~ ~4 ~ 0.5 1 0.5 0.02 100
execute if score Timerattack NAMEGOT matches 40 at @e[type=wither_skeleton,tag=NAMEGOT] run particle item{item:orange_wool} ~ ~4 ~ 0.5 1 0.5 0.02 100
execute if score Timerattack NAMEGOT matches 40 at @e[type=wither_skeleton,tag=NAMEGOT] run particle item{item:orange_wool} ~ ~5 ~ 0.5 1 0.5 0.01 100
execute if score Timerattack NAMEGOT matches 40 at @e[type=wither_skeleton,tag=NAMEGOT] run particle item{item:orange_wool} ~ ~5 ~ 0 1 0 0.01 100

execute if score Timerattack NAMEGOT matches 40 at @e[type=wither_skeleton,tag=NAMEGOT] run playsound entity.player.death master @a ~ ~ ~ 1 0.1 1
...
execute if score Timerattack NAMEGOT matches 60 at @e[type=wither_skeleton,tag=NAMEGOT] run playsound entity.player.death master @a ~ ~ ~ 1 0.1 1
