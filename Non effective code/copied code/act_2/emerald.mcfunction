/tp @e[type=PigZombie,x=-32,y=72,z=-1229,r=2] ~ ~ ~ 180 0
...
#Mène a : 
/summon Wolf -31 72 -1230 {Angry:1,PersistenceRequired:1,Attributes:[{Name:generic.maxHealth,Base:20,HealF:0.5}],CustomName:Bunny,CustomNameVisible:1}
