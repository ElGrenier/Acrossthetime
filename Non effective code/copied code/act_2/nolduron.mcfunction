...
#When dungeon of Firone finished and gems deposed do (to open the door in the hero house) : /setblock -321 105 -1266 air
#When dungeon of Kakaran finished and gems deposed do (to open the door in the hero house) : /setblock -321 105 -1261 air
...
#Ouvrir porte Otauria (/setblock -270 72 -1331 air) 
...
#When dungeon of Otauria finished and gems deposed do (to open the door in the hero house) : /setblock -321 105 -1256 air
#When dungeon of Otauria finished and gems deposed do (to open the door of Catacombs) : /setblock -271 107 -1231 air
...
#Ouvrir porte Etotsira (/setblock -224 66 -1320 redstone_block)
...
#Ouvrir porte maison Héro Donjon Ranwe (/setblock -321 105 -1251 air)
# Do /setblock -294 119 -1222 air
...
#Ouvrir porte maison Héro Donjon Echor (/setblock -321 105 -1246 air)
#Ouvrir porte Ouranos (/setblock -355 102 -1315 air )
...
#Ouvrir porte Désolation (/setblock -364 99 -1257 air)
...
#Ouvrir porte Nexus (/setblock -343 94 -1287)
/tellraw @a {text:"Le portail temporel vient de s'ouvrir, sautez dedans lorsque vous serez prêt!",color:blue}
/setblock 8 58 18 redstone_block ## A changé
