/testfor @a[x=158,y=62,z=-1356,r=8,m=2]
    ...
    /summon Silverfish 163 60 -1355 {PersistenceRequired:1,DropChances:[1.0f,0.5f,0f,0f,0.1f],Equipment:[{id:399,Count:1,tag:{display:{Name:"Ame de Cédron"}}},{id:378,Count:1,tag:{display:{Name:ECAILLE SOUVERAINE DU CHAOS,Lore:["Précieux!!","Très, TRES précieux........"]}}}],Attributes:[{Name:generic.maxHealth,Base:100,HealF:0.5},{Name:generic.attackDamage,Base:5.0},{Name:generic.movementSpeed,Base:0.3}],CustomName:Cédron,CustomNameVisible:1}
