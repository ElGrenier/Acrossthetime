...
/playsound fireworks.largeBlast @a
...
/summon FallingSand -316 101 -1205 {TileID:54,Time:1,Motion:[0.0,0.1,0.0],DropItem:0,TileEntityData:{CustomName:"Chest",Items:[{Slot:5,id:266,Count:1,tag:{display:{Name:"Grande clef"}}}]}}
...
/tp @e[type=VillagerGolem,x=-370,y=68,z=-1242,dx=30,dy=17,dz=20] -340 0 -1227
/tp @e[type=SnowMan,x=-370,y=68,z=-1242,dx=30,dy=17,dz=20] -340 0 -1227
#délai
/tp @a -340 98 -1287
