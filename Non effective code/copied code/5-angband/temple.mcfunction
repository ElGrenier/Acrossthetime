...
/tellraw @p[x=33,y=6,z=-330,r=2,m=2] {text:"Bzzzzz brrrrrr aaaaaarrrrgg!!!!!!!!,color:red}
/tp @p[x=33,y=6,z=-330,r=2,m=2] 42 6 -330
...
#chest
/summon Ghast 83 55 -275 {ExplosionPower:3,PersistenceRequired:1,Attributes:[{Name:generic.maxHealth,Base:120,HealF:0.5},{Name:generic.attackDamage,Base:3.0}]}
#lock
/playsound random.levelup @a ~ ~ ~ 1 2 1
...
/fill 108 57 -275 108 51 -270 barrier 0 replace quartz_ore
/playsound records.blocks @a 128 54 -273 2.0 1.0 1.0
...
#push again
/playsound records.mall @a 185 50 -272 3.0 1.0 1.0
/tp @e[type=SnowMan,x=149,y=45,z=-245,dx=-50,dy=20,dz=-50] 150 0 -245
/tp @e[type=VillagerGolem,x=149,y=45,z=-245,dx=-50,dy=20,dz=-50] 150 0 -245
...
/testfor @a[x=197,y=46,z=-273,r=7,m=2]
...
/testfor @a[x=211,y=43,z=-272,r=6]
...
#recharges
/scoreboard players set @a[x=208,y=45,z=-273,r=20] SOURCE 5
#livre
/give @a[x=208,y=45,z=-273,r=20] minecraft:written_book 1 0 {title:"RECHARGE de la SOURCE",author:"Namrin",pages:["{text:'RECHARGE de DAHAL\n',color:gray,bold:true,extra:[{text:'\n<*!*> UTILISER <*!*>\n',color:aqua,bold:true},{text:'\n *^-._.-^*^-._.-^*       RECHARGE             SOURCE        *^-._.-^*^-._.-^*\n',color:blue,bold:true,clickEvent:{action:run_command,value:'/scoreboard players set @p RECHARGESOURCE 1'},hoverEvent:{action:show_text,value:'Cliquez ici pour utiliser une recharge de la Source et gagner 50 DAHAL'}},{text:'\n _.-^*^-._.-^*^-._       NOMBRE DE           RECHARGES          RESTANTES      _.-^*^-._.-^*^-._ \n',color:dark_aqua,bold:true,clickEvent:{action:run_command,value:\"/tellraw @p {text:'Recharge : ',extra:[{score:{name:'*',objective:'SOURCE'},color:red,bold:true}]}\"},hoverEvent:{action:show_text,value:'Cliquez ici pour connaître le nombre de recharges restantes de la Source.'}}]}"]}

#unused give corruption
/give @a[x=208,y=45,z=-273,r=20] minecraft:written_book 1 0 {title:"CORRUPTION",author:"Namrin",pages:["{text:' - Livre de magie -\n',color:gray,bold:true,extra:[{text:'\n \n'},{text:' <= Incantation => ---------------- ',color:gold,bold:true},{text:'\n  _,.',color:dark_red,bold:true,underlined:false,extra:[{text:'¤;|/',color:dark_purple,underlined:false},{text:'~¨^¨~',color:black},{text:'\\\|:¤',color:dark_purple},{text:'.,_       ',color:dark_red,underlined:false,bold:true},{text:'CORRUPTION',strikethrough:true,color:black,bold:true},{text:'      ~``',color:dark_red,bold:true,underlined:false},{text:'*|;\\\',color:dark_purple},{text:',_._,',color:black},{text:'/;|*',color:dark_purple},{text:'``~\n',color:dark_red,underlined:false,bold:true}],clickEvent:{action:run_command,value:'/scoreboard players set @p MAGIE 2'},hoverEvent:{action:show_text,value:'Cliquez ici pour vous déchaîner! Coût : 100 Dahäl'}},{text:'\n---------------- <= Incantation => \n',color:gold,bold:true}]}","[{text:'    Description : \n',color:black,bold:true},{text:'\nLégendaire magie à l’origine du mal et du chaos imprégnant chaque royaumes... Vous vous mettez dans un état de transe, vous regagnez vos point de vie. Votre force et vitesse se décuple pendant 30 secondes.',color:blue,bold:false}]","[{text:'Attention cette puissante magie a des effets secondaires néfastes...',color:blue,bold:false}]"]}
