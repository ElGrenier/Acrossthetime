...
/playsound records.strad @a -360 90 730 20.0 1.0 1.0


#Boucle (Info cool : "m" = Gamemode donc si dans un testfor m=2 c'est que le gamemode est en aventure)
/testfor @a[x=-375,y=100,z=799,r=10,m=2] #(Les 3 tesfor active les 2 autres commandes)
/testfor @a[x=-385,y=100,z=799,r=10,m=2]
/testfor @a[x=-395,y=100,z=799,r=10,m=2]

/setblock -398 89 837 redstone_block #A modifier 
/tp @a -391 77 842
...
/setblock -378 89 837 redstone_block #A modifier
...
/summon Zombie -379 96 837 {PermanenceRequired:1} #Plusieurs fois ce commande block
...
/tp @a -775 250 -1247 #Tp les joueurs dans une un trou très long
