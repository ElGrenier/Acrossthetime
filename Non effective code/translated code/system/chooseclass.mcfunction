...
#Changer les 2 commandes
setblock 16 70 65 redstone_block
setblock -6 80 67 redstone_wire
...
execute if entity @p[x=-731,y=83,z=-1094,distance=..1]
# fait :
    scoreboard players set @p[x=-731,y=83,z=-1096,distance=..2] GUERRIER 1
    tellraw @a {"selector":"@p","bold":true,"color":"gray","extra":[{"text":" a choisi la voie du Guerrier!","color":"gray","bold":false,"italic":true}]}
    give @p[x=-731,y=83,z=-1096,distance=..2] leather_chestplate
    scoreboard players add @p[x=-731,y=83,z=-1096,distance=2] Chronoton 15
    #Eteindre la lumière porte
    #Fermer la porte

    # QQ seconde plus tard :
    tp @p[x=-731,y=83,z=-1096,distance=..2] -340 100 -1287
    effect give @a[scores={GUERRIER=1}] 22 100000 0 true
...
execute if entity @p[x=-731,y=83,z=-1112,distance=..1]
    ...
    #QQ seconde plus tard : 
    tp @p[x=-731,y=83,z=-1110,distance=..2] -340 100 -1287
...
execute if entity @p[x=-738,y=83,z=-1094,distance=..1]
    playsound entity.player.levelup master @p[x=-738,y=83,z=-1096,distance=..2]
    scoreboard players set @p[x=-738,y=83,z=-1096,distance=..2] CHASSEUR 1
    give @p[x=-738,y=83,z=-1096,distance=..2] arrow 10
    give @p[x=-738,y=83,z=-1096,distance=..2] leather_leggings
    tellraw @a {"selector":"@p","bold":true,"color":"gray","extra":[{"text":" a choisi la voie du Chasseur!","color":"gray","bold":false,"italic":true}]}
    give @p[x=-738,y=83,z=-1096,distance=..2] bow 1
    #Typo dans les commandes ici aussi ?
    give @p[x=-738,y=83,z=-1096,distance=..2] leather_boots
    scoreboard players add @p[x=-738,y=83,z=-1096,distance=..2] Chronoton 10
    #Eteindre la lumière porte
    #Fermer la porte

    #QQ seconde plus tard : 
    tp @p[x=-738,y=83,z=-1096,distance=..2] -340 100 -1287
...
tellraw @p[x=-738,y=83,z=-1111,distance=1..5] {"selector":"@p","color":"gray","bold":true,"extra":[{"text":" - Placez-vous d'abord sur la plaque de pression, puis appuyez sur l'interrupteur en face si vous avez choisi votre classe!","color":"gray","bold":false,"italic":true}]}

execute if entity @p[x=-738,y=83,z=-1112,distance=..1]
    playsound entity.player.levelup master @p[x=-738,y=83,z=-1110,distance=..2]
    scoreboard players set @p[x=-738,y=83,z=-1110,distance=..2] ALCHIMISTE 1
    give @p[x=-738,y=83,z=-1110,distance=..2] potion 2 16388
    give @p[x=-738,y=83,z=-1110,distance=..2] potion 1 8227
    tellraw @a {"selector":"@p","bold":true,"color":"gray","extra":[{"text":" a choisi la voie de l'Alchimiste!","color":"gray","bold":false,"italic":true}]}
    give @p[x=-738,y=83,z=-1110,distance=..2] potion 2 16426
    give @p[x=-738,y=83,z=-1110,distance=..2] potion 2 16460
    give @p[x=-738,y=83,z=-1110,distance=..2] experience_bottle 5
    #Eteindre la lumière porte
    #Fermer la porte

    #QQ seconde plus tard :
    tp @p[x=-738,y=83,z=-1110,distance=..2] -340 100 -1287
...
execute if entity @p[x=-745,y=83,z=-1094,distance=..1]
    playsound entity.player.levelup master @p[x=-745,y=83,z=-1096,distance=..2]
    scoreboard players set @p[x=-745,y=83,z=-1096,distance=..2] GUERISSEUR 1
    tellraw @a {"selector":"@p","bold":true,"color":"gray","extra":[{"text":" a choisi la voie du Guérisseur!","color":"gray","bold":false,"italic":true}]}
    scoreboard players add @p[x=-745,y=83,z=-1096,distance=..2] Chronoton 10
    give @p[x=-745,y=83,z=-1096,distance=..2] potion 3 16453
    #Eteindre la lumière porte
    #Fermer la porte

    #QQ seconde plus tard : 
    tp @p[x=-745,y=83,z=-1096,distance=..2] -340 100 -1287
...
execute if entity @p[x=-745,y=83,z=-1112,distance=..1]
    playsound entity.player.levelup master @p[x=-745,y=83,z=-1110,distance=..2]
    scoreboard players set @p[x=-745,y=83,z=-1110,distance=..2] BOUSEUX 1
    tellraw @a {"selector":"@p","bold":true,"color":"gray","extra":[{"text":" a choisi la voie du Bouseux!","color":grey,"bold":false,"italic":true}]}
    give @p[x=-745,y=83,z=-1110,distance=..2] bread 2
    give @p[x=-745,y=83,z=-1110,distance=..2] baked_potato 1
    #Eteindre la lumière porte
    #Fermer la porte

    #QQ seconde plus tard :
    tp @p[x=-745,y=83,z=-1110,distance=..2] -340 100 -1287
...
execute if entity @p[x=-752,y=83,z=-1094,distance=..1]
    playsound entity.player.levelup master @p[x=-752,y=83,z=-1096,distance=..2]
    scoreboard players set @p[x=-752,y=83,z=-1096,distance=..2] NINJA 1
    give @p[x=-752,y=83,z=-1096,distance=..2] minecraft:written_book 1 0 {title:"INSAISISSABLE",author:"Calypso",pages:["{"text":' - Livre de magie -\n',"color":"gray","bold":true,"extra":[{"text":'\n \n'},{"text":' <= Incantation => ---------------- ',"color":gold,"bold":true},{"text":'\n _.-*^*-._.-*^*-._     INSAISISSABLE    _.-*^*-._.-*^*-._\n',"color":red,"bold":true,clickEvent:{action:run_command,value:'/scoreboard players set @p MAGIE 17'},hoverEvent:{action:show_text,value:'Cliquez ici pour lancer le sort! Coût : 15 Dahäl'}},{"text":'\n---------------- <= Incantation => \n',"color":gold,"bold":true}]}","[{"text":'    Description : \n',"color":black,"bold":true},{"text":'\nAméliore la vitesse de déplacement pendant 20 secondes.',"color":"blue","bold":false}]"]}
    tellraw @a {"selector":"@p","bold":true,"color":"gray","extra":[{"text":" a choisi la voie du Ninja!","color":"gray","bold":false,"italic":true}]}
    give @p[x=-752,y=83,z=-1096,distance=..2] leather_helmet
    scoreboard players add @p[x=-752,y=83,z=-1096,distance=..2] Chronoton 30
    #Eteindre la lumière porte
    #Fermer la porte

    #QQ seconde plus tard : 
    tp @p[x=-752,y=83,z=-1096,distance=..2] -340 100 -1287
...
execute if entity @p[x=-752,y=83,z=-1112,distance=..1]
    playsound entity.player.levelup master @p[x=-752,y=83,z=-1110,distance=..2]
    scoreboard players set @p[x=-752,y=83,z=-1110,distance=..2] DRUIDE 1
    give @p[x=-752,y=83,z=-1110,distance=..2] minecraft:written_book 1 0 {title:"LOUP LUGUBRE",author:"Calypso",pages:["{"text":' - Livre de magie -\n',"color":"gray","bold":true,"extra":[{"text":'\n \n'},{"text":' <= Incantation => ---------------- ',"color":gold,"bold":true},{"text":'\n _.-*^*-._.-*^*-._     LOUP LUGUBRE    _.-*^*-._.-*^*-._\n',"color":red,"bold":true,clickEvent:{action:run_command,value:'/scoreboard players set @p MAGIE 15'},hoverEvent:{action:show_text,value:'Cliquez ici pour lancer le sort! Coût : 35 Dahäl'}},{"text":'\n---------------- <= Incantation => \n',"color":gold,"bold":true}]}","[{"text":'    Description : \n',"color":black,"bold":true},{"text":'\nInvoque 4 loups combattants les ennemis squelettes.',"color":"blue","bold":false}]"]}
    tellraw @a {"selector":"@p","bold":true,"color":"gray","extra":[{"text":" a choisi la voie du Druide!","color":"gray","bold":false,"italic":true}]}
    give @p[x=-752,y=83,z=-1110,distance=..2] bone 20
    scoreboard players add @p[x=-752,y=83,z=-1110,distance=..2] Chronoton 15
    #Eteindre la lumière porte
    #Fermer la porte

    #Qq seconde plus tard : 
    tp @p[x=-752,y=83,z=-1110,distance=..2] -340 100 -1287