...
summon silverfish 163 60 -1355 {PersistenceRequired:1b,DropChances:[1.0f,0.5f,0f,0f,0.1f],Equipment:[{id:378,Count:1,tag:{display:{Name:"ECAILLE SOUVERAINE DU CHAOS",Lore:["Précieux!!","Très, TRES précieux........"]}}}],attributes:[{Name:max_health,Base:100,HealF:0.5},{Name:attack_damage,Base:5.0},{Name:movement_speed,Base:0.3}],CustomName:'{"text":"Cédron"}',CustomNameVisible:1b}
