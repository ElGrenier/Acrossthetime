...
summon wolf 151 48 -1353 {Angry:1,PersistenceRequired:1b,DropChances:[1.0f,0f,0f,0f,0f],Equipment:[{}],attributes:[{id:max_health,base:60}],CustomName:"Skrappy",CustomNameVisible:1b}
