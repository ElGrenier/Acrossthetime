...
summon creeper -68 31 -289 {PersistenceRequired:1b,CustomName:'"Creepy"',powered:0b,ExplosionRadius:2,Fuse:100,ignited:0b,attributes:[{Name:max_health,Base:30,HealF:0.5}]}
tp @p -67 31 -288
