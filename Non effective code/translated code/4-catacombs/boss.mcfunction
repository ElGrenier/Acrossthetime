...
execute if entity @a[x=-370,y=68,z=-1242,dx=30,dy=17,dz=20]
...
#boss dead
execute unless entity @e[type=witch,x=-370,y=68,z=-1242,dx=30,dy=17,dz=20]
#rematch
execute unless entity @e[type=skeleton,x=-370,y=68,z=-1242,dx=30,dy=17,dz=20]
