...
summon falling_block -282 109 -1241 {TileID:54,Time:1,Motion:[0.0,0.1,0.0],DropItem:0b,TileEntityData:{CustomName:"Chest",Items:[{Slot:7,id:348,Count:1,tag:{display:{Name:"Clef Maison Hero"}}}]}}
