...
execute if entity @e[type=silverfish,x=145,y=65,z=-1345,dx=25,dy=-15,dz=-25]
    summon falling_block 158 66 -1355 {TileID:54,Time:1,Motion:[0.0,1.0,0.0],DropItem:0b,TileEntityData:{CustomName:"Boss' Chest",Items:[{Slot:13,id:399,Count:1,tag:{display:{Name:"Ame de Cédron"}}}]}}
