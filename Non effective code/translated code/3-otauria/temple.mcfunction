...
tp @p[x=-463,y=9,z=-1388,distance=..3] -456 71 -1401
...
playsound liquid.swim master @a
playsound liquid.water master @a
playsound liquid.swim master @a

#saute porte repos (entre boss lair)
tp @a[x=-377,y=61,z=-1416,dx=2,dy=-44,dz=-2,gamemode=adventure] -661 92 -1514
...
tp @e[type=snow_golem,x=-650,y=54,z=-1526,dx=-25,dy=-24,dz=25] -650 0 -1520
tp @e[type=iron_golem,x=-650,y=54,z=-1526,dx=-25,dy=-24,dz=25] -650 0 -1520
