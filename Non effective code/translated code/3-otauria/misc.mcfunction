...
particle poof -299 127 -1452 1 2 1 0.1 400
playsound entity.generic.explode master @a ~ ~ ~ 1.2 2 1
playsound entity.generic.explode master @a ~ ~ ~ 1.2 1 1

#info haricot
tellraw @a {"text":"Cette fleur, elle ne doit pas être là par hasard. Elle a l'air desséchée, peut-être qu'en replantant une graine elle repoussera?","italic":true,"color":"gray"}

#placer haricot
scoreboard players add @a QUETESEC 1
#84 à 202
setblock -202 84 -1416 minecraft:melon
setblock -202 127 -1416 minecraft:melon
setblock -202 202 -1416 minecraft:melon
...
tp @a[x=-204,y=84,z=-1416,distance=..20] -1479 143 -1425
